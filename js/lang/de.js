...
export const ui = {
  ...
  'tile.new': 'Neu',
  'status.fresh': '{n} neu',
  'live.start': 'Deine Partien werden analysiert. Das kann ein paar Minuten dauern.',
  'live.done': 'Analyse abgeschlossen: {n} von {total} Achievements freigeschaltet.',
  'live.fresh': 'Davon {n} neu.',
