...
# --- Further common openings -------------------------------------------------
# WHITE
printOpening("london", "d4 d5 Bf4")
printOpening("vienna", "e4 e5 Nc3")
printOpening("bishopsopening", "e4 e5 Bc4")
printOpening("catalan", "d4 Nf6 c4 e6 g3")
printOpening("bird", "f4")
printOpening("larsen", "b3")
printOpening("trompowsky", "d4 Nf6 Bg5")
printOpening("fourknights", "e4 e5 Nf3 Nc6 Nc3 Nf6")
# BLACK
printOpening("kingsindian", "d4 Nf6 c4 g6 Nc3 Bg7")
printOpening("nimzoindian", "d4 Nf6 c4 e6 Nc3 Bb4")
printOpening("grunfeld", "d4 Nf6 c4 g6 Nc3 d5")
printOpening("qgd", "d4 d5 c4 e6")
printOpening("slav", "d4 d5 c4 c6")
printOpening("alekhine", "e4 Nf6")
printOpening("philidor", "e4 e5 Nf3 d6")
printOpening("petrov", "e4 e5 Nf3 Nf6")
